    ...
    try {
        ...
        if (search) {
            cities = cities.filter((c) =>
                ...
                c.districtId?.districtName?.toLowerCase().includes(search.toLowerCase())
            );
        }
        ...
        else if (sort === "districtAsc") {
            cities.sort((a, b) =>
                (a.districtId?.districtName || "").localeCompare(b.districtId?.districtName || "")
            );
        }
        else if (sort === "districtDesc") {
            cities.sort((a, b) =>
                (b.districtId?.districtName || "").localeCompare(a.districtId?.districtName || "")
            );
        }
        ...
        if (page && limit) {
            ...
            const totalPages = Math.ceil(totalCities / limitNum) || 1;
